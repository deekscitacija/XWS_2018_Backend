...
public interface ReservationRepository extends JpaRepository<Reservation, Long>{
	...
	public Page<Reservation> findByRegisteredUserAndReservationStatusOrderByFromDateDesc(RegisteredUser registeredUser, ReservationStatus reservationStatus, Pageable pageable);
